...
# Vanilla Router-Full.
bash scripts/train/finetune/full.sh --task gsm --model olmoe --total_batch_size 256 --num_train_epochs 4 --devices 3,4 --port 29010 --lr 2e-5 --per_device_train_batch_size 4 --per_device_eval_batch_size 4