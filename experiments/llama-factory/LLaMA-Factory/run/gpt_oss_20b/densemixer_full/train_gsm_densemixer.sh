...
export DENSEMIXER_DEEPSEEK_V2=0
...
CONFIG_FILES=(
    "gpt_oss_gsm_lr1e-6.yaml"
    # "qwen1.5_gsm_lr3e-6.yaml"
)

export WANDB_API_KEY="$WANDB_API_KEY"
export WANDB_PROJECT="MoE-Finetune-gpt-oss-20b"
...
for config_file in "${CONFIG_FILES[@]}"; do
    ...
    # define the command
    CMD="CUDA_VISIBLE_DEVICES=0,1,2,3 llamafactory-cli train examples/train_full/gpt_oss/${method}/${config_file}"
