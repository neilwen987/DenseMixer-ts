...
for config_file in "${CONFIG_FILES[@]}"; do
    ...
    # define the command
    CMD="CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 llamafactory-cli train /home/ubuntu/tiansheng/26_ICLR_btk_moe/DenseMixer-ts/experiments/llama-factory/LLaMA-Factory/examples/train_full/qwen1.5moe/full/sptopk/qwen1.5_codealpaca_lr2e-6.yaml"
